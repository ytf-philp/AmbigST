...
DATA_DIR=/zhang_m/dataset_all/en-es
lang=es
world_size=2
update_freq=16
export CUDA_VISIBLE_DEVICES=0,1
CODE_ROOT=/home/SpeechUT
MODEL_DIR=/zhang_m/model/en_es/token_sentence
...
python $CODE_ROOT/fairseq/fairseq_cli/train.py ${DATA_DIR} \
    ...
    --train-subset "train_homophone_align" \
    --valid-subset "dev_homophone_align" \
    --fp16 \
    --seed 1 \
    \
    --ddp-backend no_c10d \
    ...
    --apply-mask --mask-prob 0.5 --mask-length 10 \
    --freeze-pretrain -1 \
    --log-format json \
    --log-interval 100 \
