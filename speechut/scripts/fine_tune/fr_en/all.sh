...
w2v_path=/zhang_m/model/pretrain/checkpoint_297_600000.pt
DATA_DIR=/zhang_m/covost/fr
lang=fr
world_size=4
update_freq=8
export CUDA_VISIBLE_DEVICES=0,1,2,3
CODE_ROOT=/home/SpeechUT
MODEL_DIR=/zhang_m/model/fr_en/ambigst
...
python $CODE_ROOT/fairseq/fairseq_cli/train.py ${DATA_DIR} \
    ...
    --task speech_to_text_new_acc \
    --config-yaml config_${lang}en.yaml \
    --train-subset "train_st_homophone" \
    --valid-subset "dev_st_homophone" \
    --fp16 \
    --seed 1 \
    \
    --ddp-backend no_c10d \
    ...
    --criterion multi_task_cross_entropy_dislltion_sentence_token --report-accuracy \
    --label-smoothing 0.3 \
    --optimizer adam \
    --clip-norm 1.0 \
    --lr 3e-05 \
