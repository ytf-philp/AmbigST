...
@register_task("speech_to_text_new_acc")
class SpeechToTextTasknewacc(LegacyFairseqTask):
    @classmethod
    ...
    def build_model(self, args, from_checkpoint=False):
        ...
        model =super(SpeechToTextTasknewacc, self).build_model(args, from_checkpoint)
        return model
